    ...
    <PageBlock>
      <Card transparent style={{ maxWidth: 720 }}>
        <Section>
          <Paragraph>
            <Text superstandard>
              To better understand these options, let's step through them one by
              one.
            </Text>
          </Paragraph>
        </Section>
        <Section>
          ...
          <Paragraph>
            <Text superstandard>
              Standard text is 14px over 2 grid rows on desktop, and 18px over 3
              grid rows on mobile.
            </Text>
          </Paragraph>
        </Section>
    ...
    <PageBlock>
      <Card transparent style={{ maxWidth: 720 }}>
        <Section>
          <Paragraph>
            <Text superstandard>
              Since standard text is responsive, comprised of two different font
              sizes, you might find yourself wanting to pin your text to a
              single font size across both desktop and mobile.
            </Text>
          </Paragraph>
        </Section>
        <Section>
          ...
          <Paragraph>
            <Text superstandard>
              If you want your text to stay at 18px regardless of screen size,
              you can use the &ldquo;superstandard&rdquo; text variant. This is
              useful for long-form text, for example. In fact, this
              documentation makes heavy use of superstandard text.
            </Text>
          </Paragraph>
        </Section>
      </Card>
    ...
    <PageBlock>
      <Card transparent style={{ maxWidth: 720 }}>
        <Section>
          ...
          <Paragraph>
            <Text superstandard>
              Alternatively, if you want your text to stay at 14px regardless of
              screen size, you can use the &ldquo;substandard&rdquo; text
              variant. This is useful for ancillary content, or content that is
              meant to be easily skimmable.
            </Text>
          </Paragraph>
        </Section>
      </Card>
    ...
    <PageBlock>
      <Card transparent style={{ maxWidth: 720 }}>
        <Section>
          ...
          <Paragraph>
            <Text superstandard>
              In extremely rare cases where smaller text is required, you can
              use the &ldquo;small&rdquo; text variant, which is 12px over 2
              grid rows on both desktop and mobile.
            </Text>
          </Paragraph>
        </Section>
      </Card>
    ...
    <PageBlock>
      <Card transparent style={{ maxWidth: 720 }}>
        <Section>
          ...
          <Paragraph>
            <Text superstandard>
              ...
              21px over 3 grid rows on mobile. Due to the size restrictions of
        ...
        <Section>
          ...
          <Paragraph>
            <Text superstandard>
              For page-level headings, hero text is 42px over 6 grid rows on
    ...
    <PageBlock>
      <Card transparent style={{ maxWidth: 720 }}>
        <Section>
          ...
          <Paragraph>
            <Text superstandard>
              For large content-level headings, headline text is 28px over 4
    ...
    <PageBlock>
      <Card transparent style={{ maxWidth: 720 }}>
        <Section>
          ...
          <Paragraph>
            <Text superstandard>
              For section-level headings, heading text is 21px over 3 grid rows
        ...
        <Section>
          ...
          <Paragraph>
            <Text superstandard>
              ...
              text is 18px over 3 grid rows on desktop.
            </Text>
          </Paragraph>
        </Section>
      </Card>
