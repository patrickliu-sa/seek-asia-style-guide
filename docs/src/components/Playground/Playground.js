...
const renderAsideProfile = () => (
  <Card transparent>
    <Section>
      ...
      <Text secondary>
        Employers cant view your profile or resumes or contact you with job
        opportunities.
      </Text>
    </Section>
  </Card>
...
const renderAsideRecommendedJobs = () => (
  <Card>
    <Section>
      ...
      <Text>
        Every day we look for new opportunities for you based on your profile,
        search, save and apply activity.
      </Text>
      <Text>
...
const renderAsideMyActivity = () => (
  <div className={styles.activityPanel}>
    ...
    <div className={styles.activityMobileCustom}>
      <div className={styles.touchable}>No Cover Letter</div>
      ...
      <div>
          ...
          <AsidedLayout size="340px">
            <Section>
              <AsidedLayout renderAside={renderAsideProfilePhoto} size="400px">
                <Text hero className={styles.photo}>
                  TC
                </Text>
              </AsidedLayout>
            </Section>
          ...
          <AsidedLayout reverse renderAside={renderAsideProfile} size="340px">
            <Card>
              <Section>
                ...
                <Text>
                  Add a personal summary to your profile as a way to introduce
                  who you are.
                </Text>
            ...
            <Card>
              <Section>
                ...
                <Text>
                  The more you let employers know about your experince the more
            ...
            <Card>
              <Section>
                ...
                <Text>
                  Update your privacy setting to “Standard” so that employers
                  can view your resumé and get in contact with job
                  opportunities.{' '}
              ...
              <Card key={n}>
                <Section>
                  <AsidedLayout
                    ...
                    <Text>
                      Are you a Registered Nurse and looking for variety and
                      challenges on a daily basis? Yes? Here is your chance -
          ...
          <AsidedLayout
            ...
            <CardGroup>
              ...
              <Card>
                <Section>
                  <Text>
                    You must have the <Strong>right to live and work</Strong> in
                    this location to apply for this job.
                  </Text>
                </Section>
              </Card>
            </CardGroup>
        ...
        <PageBlock>
          ...
          <Card>
            <Section>
              <Text>
                Expired jobs remain on SEEK for 90 days after last advertised,
                or until they are removed by the advertiser.
                <br />
                <br />
              </Text>
            ...
            <Card>
              <Section>
                ...
                <Text>
                  ...
                  vel sapien lorem. Duis viverra semper lacus. Vestibulum ipsum
                  ipsum, imperdiet a nulla eget, consequat mattis urna.
                  Pellentesque habitant morbi tristique senectus et netus et
                  malesuada fames ac turpis egestas. Proin ultricies placerat
                  mattis. Vestibulum ac laoreet mauris. Cras ut turpis ultrices
                  mi placerat cursus. Sed bibendum odio eget convallis blandit.
                  Nullam placerat elit ut porttitor dignissim. Curabitur a risus
                  enim. Nullam sit amet nulla finibus, rutrum diam a, viverra
                  nisi. Ut turpis sapien, convallis ut lacus sed, luctus
                  lobortis neque. Nulla facilisi. Cras vitae orci est. Etiam nec
                  dictum orci. Morbi nisl nulla, dictum vitae nunc quis, varius
                  hendrerit erat.
                </Text>
                <Text>
                  Integer at ipsum a velit elementum luctus. Sed quis odio vitae
                  lorem gravida ornare. Integer pharetra facilisis faucibus.
                  Nullam dignissim, justo hendrerit lacinia pulvinar, nulla
                  sapien condimentum lacus, a tincidunt est nibh non neque.
                  Fusce quis leo accumsan, tempus nisl nec, gravida leo. Ut non
                  augue eget enim tempor fringilla. Nulla pellentesque
                  condimentum risus at consequat. Sed nibh nunc, consectetur sed
                  massa eleifend, dapibus sollicitudin nisl. Nullam leo lorem,
                  mollis vel dolor quis, tristique laoreet ligula. Nam id mi in
                  ante consectetur sagittis vitae ac magna. Fusce iaculis, nibh
                  ac pellentesque luctus, eros lacus ultrices ligula, eget
                  tincidunt metus est at nisl. Nam consectetur eros odio, nec
                  molestie nibh rhoncus at. Aenean augue tortor, sodales non
                  faucibus eget, hendrerit vitae quam. Integer tincidunt laoreet
                  euismod.
                </Text>
              </Section>
            </Card>
          ...
          <CardGroup>
            ...
            <Card>
              <Section>
                ...
                <Text>
                  <Positive>Positive text</Positive>
                </Text>
                <Text>
