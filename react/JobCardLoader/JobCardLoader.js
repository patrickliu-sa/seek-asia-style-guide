    ...
    <Card className={styles.root}>
      <div className={styles.loader}>
        <div className={styles.animatedBackground}>
          <div
            className={`${styles.backgroundMasker} ${styles.companyRight}`}
          />
          <div
            className={`${styles.backgroundMasker} ${styles.companyBottom}`}
          />
          <div className={`${styles.backgroundMasker} ${styles.headerRight}`} />
          <div
            className={`${styles.backgroundMasker} ${styles.headerBottom}`}
          />
          ...
          <div
            className={`${styles.backgroundMasker} ${styles.locationRight}`}
          />
          <div
            className={`${styles.backgroundMasker} ${styles.locationBottom}`}
          />
          <div className={`${styles.backgroundMasker} ${styles.salaryRight}`} />
          <div
            className={`${styles.backgroundMasker} ${styles.salaryBottom}`}
          />
