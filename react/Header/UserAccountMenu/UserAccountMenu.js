  ...
  return (
    <ul className={styles.root}>
      <Hidden
        desktop
        component="li"
        className={classnames(activeTab === 'Job Search' && styles.activeTab)}>
        {linkRenderer({
      ...
      <li
        className={classnames(
          activeTab === 'Saved & Applied Jobs' && styles.activeTab
        )}>
        {linkRenderer({
      ...
      <Hidden
        ...
        component="li"
        className={classnames(
          activeTab === 'Applied Jobs' && styles.activeTab
        )}>
        {linkRenderer({
      ...
      <Hidden
        ...
        component="li"
        className={classnames(
          activeTab === 'Recommended Jobs' && styles.activeTab
        )}>
        {linkRenderer({
      ...
      {locale === 'NZ' ? null : (
        <Hidden
          ...
          component="li"
          className={classnames(
            activeTab === 'Company Reviews' && styles.activeTab
          )}>
          {linkRenderer({
